"""
Django settings for MohammedProj project.

Adjusted for Render.com deployment (Production-ready).
"""
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Optional, if using a templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
